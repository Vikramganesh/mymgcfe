...
@Component({
  selector: 'app-supervvendorsalarypayments',
  templateUrl: './supervvendorsalarypayments.component.html',
  styleUrls: ['./supervvendorsalarypayments.component.scss']
})
export class SupervvendorsalarypaymentsComponent implements OnInit {
  ...
  SignForm() {
    ...
    console.log('rtyugij',this.attendanceReg.value);
    this.service.vendor_payment(this.attendanceReg.value).subscribe(
      ...
      // if (this.todayemp.length === 0) {
        ...
        for ( let i = 0; i < this.emps.length; i++) {
          ...
          this.t.push(this.fb.group({
              id: [this.emps[i].vendor_id],
              ven_name: [this.emps[i].vendor_name, Validators.required],
